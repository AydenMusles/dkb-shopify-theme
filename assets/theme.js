...
(function() {
  ...
  theme.classes.FrameworkXMenu = (function() {
    ...
    FrameworkXMenu.prototype.listeners = function() {
      var _this;
      _this = this;
      _this.parents_with_sub_menu.on('mouseenter.PartialMainMenu touchstart.PartialMainMenu', function(e) {
        return _this.slideDown($(this).find('> a'));
      });
      _this.parents_with_sub_menu.on('mouseleave.PartialMainMenu', function() {
      ...
      return _this.sub_menu_items.on('touchstart', function(e) {
    ...
    FrameworkXMenu.prototype.resizeListeners = function() {
      var _this;
      _this = this;
      return $(window).on('resize.MainMenu', _this.debounce(100, function() {
        return _this.checkOverlap();
      }));
    };
    ...
    FrameworkXMenu.prototype.slideDown = function(link, delay) {
      var _this, display_type, link_wrapper, sub_menu;
      if (delay == null) {
        delay = false;
      }
      _this = this;
      ...
      if (delay) {
        _this.timer = setTimeout(function() {
          return _this.slideDown(link, false);
        }, delay);
      } else {
  ...
  theme.classes.XMenu = (function(superClass) {
    ...
    XMenu.prototype.headerListeners = function() {
      ...
      _this.header.on('mouseenter', function(e) {
    ...
    XMenu.prototype.slideDown = function(link, delay) {
      ...
      _this = this;
      if (_this.header_bg.css('opacity') !== '0.95' && _this.transparent_header) {
        delay = 400;
      }
